...
var _InfiniteLoader = require('react-virtualized/dist/commonjs/InfiniteLoader');
...
var _CellMeasurerCache = require('react-virtualized/dist/commonjs/CellMeasurerCache');
...
var MuiVirtualList = function (_Component) {
  ...
  function MuiVirtualList() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MuiVirtualList.__proto__ || Object.getPrototypeOf(MuiVirtualList)).call.apply(_ref, [this].concat(args))), _this), _this.cache = new _CellMeasurerCache.CellMeasurerCache({
      fixedWidth: true,
      defaultHeight: 48,
  ...
  _createClass(MuiVirtualList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(VirtualList, _extends({
        width: width
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            getInfiniteLoaderProps ? _react2.default.createElement(
              _InfiniteLoader.InfiniteLoader,
